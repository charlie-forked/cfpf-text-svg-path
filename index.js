...
export default class TextToSVG {
  constructor(font) {
    ...
    if (!font) {
      (async () => {
        const response = await fetch('https://tug.ctan.org/fonts/roboto/opentype/Roboto-Regular.otf');
  ...
  async load(file = 'https://tug.ctan.org/fonts/roboto/opentype/Roboto-Regular.otf') {
